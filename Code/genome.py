...
class DefaultGenome(object):
    ...
    def mutate(self, config):
        ...
        prob_add_node = config.node_add_prob*self.mutation_rate*(1-self.fitness_change/self.total_fitness_change)
        prob_add_connection = config.conn_add_prob*self.mutation_rate*(1-self.fitness_change/self.total_fitness_change)
        prob_delete_node = config.node_delete_prob*self.mutation_rate*(1-self.fitness_change/self.total_fitness_change)
        prob_delete_connection = config.conn_delete_prob*self.mutation_rate*(1-self.fitness_change/self.total_fitness_change)
